...
const Sidebar = () => {
    ...
    return (
        <div className='d-none d-md-flex flex-column justify-content-between p-3 sidebar me-3 shadow-sm rounded my-3 bg-white'>
            <div class="">
                <div class="my-4 menu">
                    <a href="" class="icon mb-4 text-decoration-none" onClick={handleHome}>
                        <img src={grid} alt="" />
                        <span class="ms-3">Dashboard</span>
                    </a>
                </div>
                <div class="my-4 menu">
                    <a href="" class="icon text-decoration-none" onClick={handleTransfer}>
                        <img src={arrow} alt="" />
                        <span class="ms-3">Transfer</span>
                    </a>
                </div>
                <div class="my-4 menu">
                    <a href="" class="icon my-4 text-decoration-none" onClick={handleTopup}>
                        <img src={plus} alt="" />
